...
if (isset($_POST["category"])) {
    ...
    echo "
            <div class='nav nav-pills nav-stacked'>
                <li class='active '>
                    <a>
                        <h4 class='sizeactive'>Categories</h4>
                    </a>
                </li>
            ";
            ...
            <ul class='grid cs-style-4'>
                <li style='width: 250px; margin-left: -24px; margin-top: -25px;'>
                    <figure>
                        ...
                        <figcaption>
                            <h4 style='color:rgb(255, 231, 77);' class='center'>$pro_title</h4>
                            <h3 class='center lightyellow' style='font-size: 15px;'>Harga: Rp $pro_price </h3><br>
                            <h5 style='color:  rgb(255, 231, 77);' class='center'>Gambar: $pro_des</h5>
                        </figcaption>
                    </figure>
                </li>
                <h4 class='center' style='margin-top: -13px;'>$pro_title</h4>
                <h3 class='center lightyellow' style='    margin-top: 0px; font-size: 15px;'>Harga: Rp $pro_price </h3><br>
                <button 
                                pid='$pro_id' 
...
<div style='z-index: 1;' id='detail' class='overlay'>
        <div class='popup_changepassword'>
            ...
            <div class='content'>
                ...
                <label>Nama Produk: <b style='color: #fe980f'>$pro_title</b></label><br>
                <label>Giá: <b style='color: #fe980f'>Rp $pro_price </b></label><br>
...
if (
    isset($_POST["get_seleted_Category"]) ||
    ...
    if (isset($_SESSION["uid"])) {
        ...
        if ($count > 0) {
            echo "
                    <div class='alert alert-warning'>
                        ...
                        <b>Produk sudah ada di <a style='color: red' href='cart.php'> cart </a> anda!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
            ...
            if (mysqli_query($con, $sql)) {
                ...
                <div class='alert alert-success'>
                    ...
                    <b>Produk telah ditambahkan ke<a style='color: red' href='cart.php'> Cart</a> !</b>
                </div>
                    ";
            }
        }
        ...
        if ($count1 > 0) {
            echo "
                    <div class='alert alert-warning'>
                        <a href='#' 
                            ...
                            data-dismiss='alert' 
                            aria-label='close'>&times;
                        </a>Produk sudah ada di keranjang Anda!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
           ...
           <div class='alert alert-success'>
                ...
                <b>Anda membeli dalam mode tamu!. Anda dapat <b>login</b> atau <a href='customer_registration.php' style='color: blue'>mendaftar</a> akun baru</b>
            </div>
...
";
        ...
        if (isset($_POST["cart_checkout"])) {
            ...
            $querrypay = "SELECT *FROM user_info WHERE first_name = '$namepay';";    // Pembayaran
            ...
            echo "
                ...
                <div class='row'>
                    ...
                    <div class='col-md-4'>
                        <h1 style=' margin-left: 43px;'>
                            <a href='#popup2' 
                            type='button'>
                                <img title='Klik Pembayaran' src='images/pay1.png' 
                                width='150px' 
                                height='100px'>
                            </a>
                        </h1>
                ...
                <div style='z-index: 9999;' id='popup2' class='overlay'>
                    <div class='pay_popup'>
                        ...
                        <div class='content'>
                            <h4><u>Informasi Pelanggan</u></h4>
                            <h5>Klien:<b style='color: blue'> $namepay $lastname</b></h5>
                            <h5>Alamat: <b style='color: blue'> $addresspay</b></h5>
                            <h5>No Telfon: <b style='color: blue'> $phonepay</b></h5>
                            <h5>Email: <b style='color: blue'> $emailpay</b></h5>
                            <hr>
                            <h4><u>Informasi Pesanan</u></h4>
                            ";
            echo "<table border='1'>
                <tr>
                    <th class='center'>Urutan Numerik</th>
            ...
            echo "
                    ...
                    <tr>
                        <td colspan='3'><b style='color: blue'>Jumlah Harga</b></td>
...
if (isset($_POST["removeFromCart"])) {
    ...
    <div class='alert alert-danger'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        <b>Produk telah dihapus dari keranjang Anda!</b>
    </div>
    ";
    }
}
...
if (isset($_POST["updateProduct"])) {
    ...
    <div class='alert alert-success'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        <b>Produk telah diperbarui...Kembali ke <a style='color:red' href='index.php'>Beranda</a>untuk melanjutkan berbelanja!!</b>
    </div>
    ";
    }
}
        ...
        echo "
            ...
            <div class='row'>
                ...
                <div class='col-md-1' style='margin-left: -47px; margin-top: 5px;'>
                    <a href=''>
                        <img src='images/reload.png' title='Buka halaman' style='width: 20px;'></a>
                </div>	
...
if (isset($_POST["outhistory"])) {
    $namepay = $_SESSION["name"];
    $querrypay = "SELECT *FROM user_info WHERE first_name = '$namepay';";    // Riwayat transaksi
    $rpay = mysqli_query($con, $querrypay);
    $rowpay = mysqli_fetch_array($rpay);
    ...
    <div class='alert alert-success'>
        ...
        <b>
            ...
            </a> Pembayaran berhasil. Sampai jumpa lagi!!
        </b>
    </div><script>alert('[Modern Bag] Pembayaran berhasil. Sampai jumpa lagi!')</script>
    ";
    }
...
if (isset($_POST["deleteallguest"])) {
    ...
    <div class='alert alert-success'>
        ...
        <b>
            <a href='index.php'>
                <b style='color:red'>[Modern Bag]</b>
            </a>Berhasil dihapus. Sistem secara otomatis memperbarui keranjang belanja setelah<b>3s</b>...
        </b>
        <script type='text/javascript'>
            init_reload();
            function init_reload(){

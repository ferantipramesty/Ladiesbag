                            ...
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" placeholder="Tên" id="f_name" name="f_name"
                                            class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="f_name">Họ</label>
                                        <input type="text" placeholder="Họ" id="l_name" name="l_name"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" placeholder="Số điện thoại" id="mobile" name="mobile"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" placeholder="Địa chỉ 1" id="address1" name="address1"
                                            class="form-control">
                                    </div>
                                    <p><br /></p>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input style="float:right;" value="Đăng kí" type="button"
                                                id="signup_button1" name="signup_button1"
